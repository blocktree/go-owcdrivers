...
func getTransferAssetWithPayload(to AssetTransfer, addressPrefix AddressPrefix) (*TxOut, error) {
	...
	if strings.Index(to.Address, prefixStr) == 0 {
		...
		return &TxOut{uint64ToLittleEndianBytes(0), redeem}, nil
	}
	...
	return &TxOut{uint64ToLittleEndianBytes(0), hash}, nil
}
