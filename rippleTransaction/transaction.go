...
func CreateEmptyRawTransactionAndHash(from, pubkey string, destinationTag int32, sequence uint32, to string, amount, fee uint64, lastLedgerSequence uint32, memoType, memoData, memoFormat string) (string, string, error) {
